...
In mehreren GitHub-Repositories liegt der Code der Produktionsumgebung mit Entwicklungs- sowie Masterbranches. Zum Entwickeln von Code wird ein eigenständiger Entwicklungsserver bereitgestellt, worunter zur Produktionsumgebung adäquate Testseiten erstellt werden können. Dadurch muss nicht auf Liveservern, welche die Kundeninstanzen betreffen würde, getestet werden. Soll neuer Code entwickelt werden, kann sich vom Entwicklungs- oder Masterbranch der aktuelle Code geholt und ein Featurebranch erstellt werden.
